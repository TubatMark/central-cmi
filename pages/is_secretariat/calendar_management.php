...
?>
<?php
$pageTitle = "Calendar Management - Central CMI";
...
?>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-text-primary">Calendar Management</h1>
                <p class="text-text-secondary mt-2">Manage schedules, deadlines, and activity timelines</p>
            </div>
            <div class="flex space-x-3 mt-4 sm:mt-0">
                <button type="button" class="btn-secondary" onclick="exportCalendar()">
    ...
    <script>
        ...
        function updateUpcomingEvents() {
            ...
            upcomingSchedulesContainer.innerHTML = sortedSchedules.map(schedule => {
                const scheduleDate = new Date(schedule.date_start);
            ...
            content.innerHTML = `
                <div class="flex items-center mb-4">
                    <div class="bg-${typeInfo.color}-100 p-3 rounded-full mr-4">
                        <i class="fas fa-${typeInfo.icon} text-${typeInfo.color} text-xl"></i>
                    </div>
                    <div>
                        <h4 class="text-lg font-semibold text-text-primary">${schedule.title}</h4>
                        <p class="text-sm text-text-secondary">${typeInfo.label}</p>
                    </div>
                </div>
        ...
        function viewAllEvents() {
            ...
            // Here you would implement view all events logic
        }
        ...
        function viewConflicts() {
            ...
            // Show conflicts in the beautiful modal
